...
```bash
go get -u github.com/huangzhengshun/hdf5
```
...
```bash
go list -m github.com/huangzhengshun/hdf5
```
...
**Problem**:
```
go: github.com/huangzhengshun/hdf5@vX.Y.Z: reading github.com/huangzhengshun/hdf5/go.mod at revision vX.Y.Z: unknown revision vX.Y.Z
```
...
**Problem**:
```
go: github.com/huangzhengshun/hdf5 requires go >= 1.25
```
...
**Problem**:
```
package github.com/huangzhengshun/hdf5: cannot find package
```
...
4. **[API Reference](https://pkg.go.dev/github.com/huangzhengshun/hdf5)** - Complete GoDoc documentation
