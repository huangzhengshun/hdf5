...
Or open an issue at https://github.com/huangzhengshun/hdf5/issues with:
...
**Error**:
```
go: github.com/huangzhengshun/hdf5: unknown revision
```
...
# 4. Try again
go get github.com/huangzhengshun/hdf5@latest
```
...
2. **Search existing issues**: https://github.com/huangzhengshun/hdf5/issues
3. **Read the documentation**: https://github.com/huangzhengshun/hdf5/tree/main/docs
4. **Try the examples**: https://github.com/huangzhengshun/hdf5/tree/main/examples
...
2. **Library version**: `go list -m github.com/huangzhengshun/hdf5`
...
**Library version**: github.com/huangzhengshun/hdf5 vX.Y.Z (use `go list -m github.com/huangzhengshun/hdf5`)
**OS**: Ubuntu 22.04
...
- **GitHub Issues**: https://github.com/huangzhengshun/hdf5/issues (bugs, feature requests)
- **GitHub Discussions**: https://github.com/huangzhengshun/hdf5/discussions (questions, ideas)
- **Documentation**: https://github.com/huangzhengshun/hdf5/tree/main/docs
