...
- **[API Reference](https://pkg.go.dev/github.com/huangzhengshun/hdf5)** - Full GoDoc documentation
...
**Solution**: Your HDF5 file uses a format version we don't support yet (v1). Please file an issue at https://github.com/huangzhengshun/hdf5/issues with:
